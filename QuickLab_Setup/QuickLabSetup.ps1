...
New-VHD -ParentPath 'C:\Hyper-V\Virtual Hard Disks\Svr2019Std(D)_21-05_sysprepd.vhdx' -Path 'C:\Hyper-V\SVR-DC01\SVR-DC01_OS.vhdx' -Differencing
New-VHD -Path 'C:\Hyper-V\SVR-DC01\SVR-DC01_ADDS.vhdx' -Dynamic -SizeBytes (Invoke-Expression '20GB')
New-VM -Name 'SVR-DC01' -MemoryStartupBytes (Invoke-Expression '1GB') -BootDevice VHD -VHDPath 'C:\Hyper-V\SVR-DC01\SVR-DC01_OS.vhdx' -Path 'C:\Hyper-V' -Generation 2 -SwitchName 'vSWI_172.50.50.x'
...
New-VHD -ParentPath 'C:\Hyper-V\Virtual Hard Disks\Svr2019Std(D)_21-05_sysprepd.vhdx' -Path 'C:\Hyper-V\SVR-DC01\SVR-MGT_OS.vhdx' -Differencing
New-VM -Name 'SVR-MGT' -MemoryStartupBytes (Invoke-Expression '1GB') -BootDevice VHD -VHDPath 'C:\Hyper-V\SVR-DC01\SVR-MGT_OS.vhdx' -Path 'C:\Hyper-V' -Generation 2 -SwitchName 'vSWI_172.50.50.x'
